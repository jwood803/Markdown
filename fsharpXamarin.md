...
To help understand a bit more of the F# process I ported the Phoneword application that we work with quite a bit in [Xamarin University]() to F# with this. The results are the same if it was a C# project.
